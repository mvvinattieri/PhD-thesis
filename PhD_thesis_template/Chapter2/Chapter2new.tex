...
At each iteration, given $n_p$ number of parameters, we fix the $(n_p-1)$ parameters and vary the risk parameter $\alpha$ over a few values. The cured fraction and the proportion of high-risk families into the population are set at $p = 0.8, h = 0.3$. 
