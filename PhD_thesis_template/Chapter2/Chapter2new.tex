...
On the other hand, the family history indicator motivates the binary nature of the breast cancer risk which leads to the split of families into two a low-risk group and a highest-risk group. Thus, our objective is to develop a risk prediction model for age at breast cancer onset, say the beginning of the disease, which involves a family-spefici risk considers the familial nature of the risk, which is assumed to be latent and unchanged from birth. We allow for this latent risk, also known as frailty, to be discrete and comprise two risk levels (low and high), which we denote as 0 and 1, respectively. In the following, we explore a Multivariate Shared Frailty Cure Rate model for the study of this family-specific risk of disease onset, where frailty is referred to the latent risk, and for its prediction from the time-to-event information of a ``main subject'' vs. her closest family.
