...
Table \ref{tab:covsummaries} reports some descriptive statistics of the clean dataset composed by .

 $n = 1,603,920$ Swedish families, consisting of a total of $4,267,803$ women.
\begin{center}
\begin{table*}[!h]%
\begin{tabular*}{\textwidth}{@{\extracolsep\fill}lllll@{}}
    \toprule
    ...
    &69.9576 \\ \midrule
    BC diagnosis &Yes &No \\
    &47,914(0.0299) &1,556,006(0.9701) \\ \midrule
    EFS &Alive &Dead/emigrated &Diagnosed \\ 
    &1,408,072(0.8779) &147,914(0.0922) &47,934(0.0299) \\ \midrule
    & Yes & No \\
    FH at end of FU &105,432(0.0657) &1,498,488(0.9343) \\ 
    Parity &98,9422 (0.3831) &614,498 (0.6169)    \\ \midrule
    &Min. &Median &Mean &Max. \\ 
