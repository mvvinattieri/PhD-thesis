...
Notice that the Cure-Rate models that we develop, i.e. the Multivariate frailty Cure-Rate, the Univariate frailty Cure-Rate, and the Univariate $FH$ Cure-Rate model are parametric and thus in the analysis we explore several baseline survival distributions, including Weibull, Gamma, Lognormal, three-parameter Gamma and three-parameter Lognormal. These two last distributions are included to assess whether an increased flexibility in the distribution could benefit the inference precision and prediction accuracy. 
% qui 
