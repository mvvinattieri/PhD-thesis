...
\toprule
    ...
    Multivariate frailty Cox \\ 
    MSPE$_\text{mean}$ &3.80 (0.0020) &3.50 (0.0019) &2.85 (0.0024) &3.63 (0.0032) \\ 
    MSPE$_\text{median}$ &5.79 (0.0025) &5.64 (0.0034) &5.01 (0.0031) &3.89 (0.0023) \\ 
    $R^2_\text{mean}$ &0.23 (0.0002) &0.26 (0.0001) &0.52 (0.0001) &0.65 (0.0002) \\ 
    $R^2_\text{median}$ &0.16 (0.0001) &0.16 (0.0001) &0.26 (0.0002) &0.29 (0.0002) \\ 
    ...
    $\rho_\text{mean}$ &0.49 (0.0002) &0.55 (0.0002) &0.74 (0.0001) &0.82 (0.0001) \\  
    $\rho_\text{median}$ &0.42 (0.0002) &0.43 (0.0002) &0.53 (0.0002) &0.55 (0.0002) \\  
    Rank $\rho_\text{mean}$ &0.24(0.0001) &0.28 (0.0001) &0.48 (0.0001) &0.58 (0.0001) \\  
    Rank $\rho_\text{median}$ &0.11 (0.0001) &0.15 (0.0001) &0.36 (0.0001) &0.49 (0.0001) \\ 
    \midrule
    Univariate $FH$ Cox \\
    MSPE &5.91 (0.0022) &5.87 (0.0038) &5.67 (0.0031) &5.23 (0.0027) \\ 
    $R^2$ &0.03 (0.0001) &0.04 (0.0001) &0.13 (0.0001) &0.16 ($<$0.0001) \\ 
    $\widehat{\beta}_{\text{FH}}$ &3.59 (0.0039) &3.34 (0.0035) &3.03 (0.0014) &2.70 (0.0010) \\ 
...
\toprule
    ...
    &0.5 &0.81 (0.0011) &8.59 (0.0241) &6.06 (0.0030) &0.39 (0.0170) \\ \midrule
...
\toprule
    ...
    \end{tabular*}
    \caption{parameter recovery with a three-parameter Lognormal($\mu_0 = 8$, $\sigma_0 = 6$, $\gamma_0 = 15$) baseline survival function. Simulations are based on the parameter values $(p_0,\mu_0,\sigma_0,\gamma_0)=(0.85,8,6,15)$ with 100 simulated samples of 100,000 families.}
    \label{tab:1.8}
\end{table*}
\end{center}
\newpage
