...
Therefore, we adopt the mean as the best posterior frailty risk summary and perform final computations using only the multivariate model, which is up to this point the best in performances. 
