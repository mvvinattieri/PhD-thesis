...
\toprule
    &$\theta$ &mean($\widehat{\theta}$) (se) &mean($\widehat{\beta}_{FH}$) (se) \\ \cmidrule{2-4} 
    Multivariate frailty Cox &0.2 &0.199 (0.004) &- \\
    Univariate $FH$ Cox &&- &2.835 (0.081) \\ 
    Univariate $FH(t)$ Cox &&- &5.846 (0.166) \\ \midrule
    Multivariate frailty Cox &0.5 &0.499 (0.012) &- \\ 
    Univariate $FH$ Cox &&- &1.455 (0.040) \\
    Univariate $FH(t)$ Cox &&- &2.956 (0.083) \\ \midrule
    Multivariate frailty Cox &0.8 &0.802 (0.029) &- \\ 
    Univariate $FH$ Cox &&- &1.102 (0.033) \\
    Univariate $FH(t)$ Cox &&- &2.227 (0.066) \\ \bottomrule
    \end{tabular*}
...
\toprule
    ...
    $\widehat\beta_F$ &0.91 (0.0062) &0.87 (0.0049) &0.62 (0.0017) &0.47 (0.0010) \\ 
