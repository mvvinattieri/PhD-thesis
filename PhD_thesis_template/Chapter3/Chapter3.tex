...
We are interested in studying the effect of family-specific risk on longevity.

The definition of family history refers to the collection of the survival experience of other family members. We assume that families can be defined as clusters, within which individuals share the same mortality risk. The interest is in classifying a subject’s family to one of a set of risk groups or, more generally, to estimate the family-specific risk from the available data.
