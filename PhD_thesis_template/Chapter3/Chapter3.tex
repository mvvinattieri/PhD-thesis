\chapter{Family mortality: genetic risk estimation}{Joint work with Marco Bonetti\footnote{Carlo F. Dondena Research Center, Bocconi Institute of Data Science and Analytics, Department of Social and Political Sciences, Bocconi University, Milan, 20136, Italy, email: marco.bonetti@unibocconi.it}}
\markboth{\textsc{Family mortality: genetic risk estimation}}{\textsc{Family mortality: genetic risk estimation}}\label{chapter:3}

\begin{abstract}
We study the heritability of longevity, as we assume that families can be categorized in different groups of ``risk'' of life expectancy. We may divide families into different clusters, within which they share the same risk of mortality. This risk is latent and unchanged from birth. 
